					...
					<fieldset>
						<legend>Ingrese sus Datos</legend>
							<form class="form-group" action="studentupdate.php" method="POST" >
						        ...
						        <input  pattern="[A-Za-z ]{1,45}" name="nombre" class="form-input form-control" placeholder="Ingrese Nombre Completo" required/><br>

						        <label>Edad<span><em>(requerido)</em></span></label><br>
						        <input  pattern="[0-9]{1,2}" name="edad" class="form-input form-control" placeholder="Ingrese Edad" required/><br>
						        ...
						        <input  pattern="[0-9]{1,10}" name="telefono" class="form-input form-control" placeholder="Ingrese Numero Telefonico" required/><br>
						        ...
						        <input type="text" pattern="[0-9A-Za-z_-@.]{1,35}" name="correo" class="form-input form-control" placeholder="Su Correo" required/><br>
